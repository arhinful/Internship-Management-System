    ...
    <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
            <form method="post" action="{{route('company.logout')}}">
                @csrf
                <button class="text-white btn btn-danger" href="#">Sign out</button>
            </form>
        </li>
    </ul>
</nav>
        ...
        <nav id="navbar" class="col-md-2 d-none d-md-block sidebar">
            <div class="sidebar-sticky bg-dark">
                ...
                <ul class="nav flex-column mb-2 mt-5">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white btns" href="{{route('company.dashboard')}}">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white btns" href="{{route('company.all_enrolled_student')}}">
                            <span data-feather="layers"></span>
                            <span class="">All Enrolled Students</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link text-white btns" href="{{route('company.enroll_new_student')}}">
                            <span data-feather="layers"></span>
                            <span class="">Enroll New Student</span>
                        </a>
                    </li>
                ...
                <ul class="nav flex-column">
                    <hr>
                    <li class="nav-item">
                        <a class="nav-link text-white btns" href="{{route('company.profile')}}">
                            <span data-feather="layers"></span>
